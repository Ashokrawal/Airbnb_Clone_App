...
interface PerksProps {
  selected: string[];
  handleFormData: (ev: ChangeEvent<HTMLInputElement>) => void;
}

// 3. The Data Array with Type Safety
const PERK_LIST: PerkItem[] = [
  {
    id: "wifi",
    label: "Wifi",
    iconPath:
...
const Perks: React.FC<PerksProps> = ({ selected, handleFormData }) => {
  return (
